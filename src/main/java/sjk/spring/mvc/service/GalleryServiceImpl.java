...
import sjk.spring.mvc.dao.GalleryDAO;
import sjk.spring.mvc.utils.ImgUploadUtil;
...
public class GalleryServiceImpl implements GalleryService{
    ...
    public boolean newGallery(Gallery g, MultipartFile[] img) {
        String uuid = imgutil.makeUUID(); // 식별코드(uuid) 생성
        // 확인했는데 첨부파일이 존재한다면
        ...
        // 업로드한 이미지들 중 첫번째 이미지만 일부 잘라서 썸네일로 만들기 위해
        // 파일명 생성
