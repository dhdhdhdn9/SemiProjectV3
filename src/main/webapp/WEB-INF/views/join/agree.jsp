...
<div id = "main">
	...
	<div>
	    <h2>사이트 약관 동의</h2>
	    <small class="text-muted">회원가입을 위해서 아래 사이트 이용약관 &middot; 개인정보 수집 이용에 대한 안내를 읽고 동의해주세요.</small>
	</div>
	<hr>
...
Copyright © Kakao Corp. All rights reserved.
             ...
             <div class="custom-control custrom-checkbox text-right">
                 <input class="custom-control-input" type="checkbox" name="agree1" id="agree1">
...
Copyright © Kakao Corp. All rights reserved.
             ...
             <div class="custom-control custrom-checkbox text-right">
                 <input class="custom-control-input" type="checkbox" name="agree2" id="agree2">
